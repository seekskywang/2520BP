...
//    u32 date;
   ...
   Send_To_U.back=9;
    DispBuf[6]=' ';
//	if((Test_Value.uint == 1 && Test_Value.res > 33000 && Test_Value.dot == 3) || (Test_Value.uint == 1 && Test_Value.dot == 2) || Test_Value.uint > 1)
//	{
//		for(i=0;i<6;i++)
//        DispBuf[i]='-';
//		vropen = 1;
//	}
    ...
    else
    {
        ...
        //Send_To_U.ret="/r/n";
//	 if(Test_Value_V.dot == 3 && Test_Value_V.res > 20000)
//	 {
//		 for(i=0;i<7;i++)
//         DispBuf[i]='-';
//		 vropen = 1;
